...
public abstract class EFASearchBase implements IEFASearch
{
    /**
     ...
     * @since 1.0
     */
    private final EFASearchEvent fireflyEvent = new EFASearchEvent( this );
     ...
     * @since 1.0
     */
    private EFASearchListener[] fireflySearchListenerList = {};
     ...
     * @since 1.0
     */
     public final synchronized void addEFASearchListener( EFASearchListener listener )
     {  
        EFASearchListener[] list = new EFASearchListener[
    ...
    /* ********  R E M O V E   M E T H O D S  ******** */
      ...
      * @since 1.0
      */
     public final synchronized void removeEFASearchListener( EFASearchListener listener )

 ...
 */
public class EFASearch extends EFASearchBase{
...
//    private double _crossLengthPct;
     ...
     * @param evaluator
     */
    public EFASearch(EFAOperator operator, ObjectiveFunction objectiveFunction)
    {
        _operator = operator;
    ...
    public EFAOperator getOperator()
    {
        return _operator;
    }

 ...
 */
public class AlgorithmEventProducerBase<L extends IAlgorithmListener<E>, E>
{
	private List<L> _listenerList;
	private E _event;

	public AlgorithmEventProducerBase(E event)
	{
        _event = event;
        _listenerList = new ArrayList<L>();
	}		

	public void addGeneticSearchListener(L listener)
	{

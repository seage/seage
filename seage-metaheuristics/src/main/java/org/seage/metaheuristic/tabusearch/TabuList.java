...
/**
 * The <code>TabuList</code> tracks which moves are tabu and for how long.
 *
...
public interface TabuList extends java.io.Serializable {
  ...
  /**
   * This function should be able to determine if a given move is on the tabu
   * list. The solution that is passed is the solution before the move has
   * operated on it. This helps when you can incrementally evaluate your objective

...
public interface TabuSearchListener extends java.util.EventListener {
   ...
   * 
   * @param e The {@link TabuSearchEvent} referencing the {@link TabuSearch} that
   *          started.
   * @see TabuSearchEvent
   * @see TabuSearch
   * @since 1.0
   ...
   * iterations are completed or someone has called {@link TabuSearch#stopSolving
   ...
   * 
   * @param e The {@link TabuSearchEvent} referencing the {@link TabuSearch} that
   *          made the no change in solution value move.
   * @see TabuSearchEvent
   * @see TabuSearch
   * @since 1.0-exp7
   */

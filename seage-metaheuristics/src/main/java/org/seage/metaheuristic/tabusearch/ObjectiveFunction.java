...
public interface ObjectiveFunction {
   ...
   * <tt>ObjectiveFunction</tt> a {@link Solution} and optionally pass a proposed
   * {@link Move}. If the passed move is not <tt>null</tt>, then the evaluation
   ...
   * Although all numbers are stored and calculated as <tt>double</tt>s, they are
   * cast to <tt>float</tt>s before being compared.
   * <P>

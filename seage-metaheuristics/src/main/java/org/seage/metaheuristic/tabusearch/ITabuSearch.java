...
/**
 * The <tt>TabuSearch</tt> is the main source of control for the programmer. The
...
public interface ITabuSearch extends java.io.Serializable {
   ...
   *
   * <p>
   * Implementations of <tt>TabuSearch</tt> should block on this method until the
   * iteration is done.
   * </p>
   *
   * @see #setIterationsToGo
   ...
   *
   * <p>
   * <em>Implementations of <tt>TabuSearch</tt> should synchronize this
   * method.</em>
   * </p>
   *
   ...
   * <tt>null</tt> value indicates that no aspiration criteria is to be used.
   *
   * <p>
   * <em>Implementations of <tt>TabuSearch</tt> should synchronize this
   * method.</em>
   ...
   * </p>
   *
   * @param maximizing <tt>true</tt> if the tabu search should be maximizing,
   ...
   * move it encounters at each iteration (<tt>true</tt>) or will choose the best
   * move at each iteration (<tt>false</tt>).
   *
  ...
  /**
   * Returns the aspiration critera. A <tt>null</tt> value indicates that no

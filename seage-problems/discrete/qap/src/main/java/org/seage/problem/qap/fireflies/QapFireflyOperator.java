...
public class QapFireflyOperator extends FireflyOperator
{
    ...
    public QapFireflyOperator(double initialIntensity, double initialRandomness, double finalRandomness,
            double absorption, double timeStep, boolean withDecreasingRandomness)
    {

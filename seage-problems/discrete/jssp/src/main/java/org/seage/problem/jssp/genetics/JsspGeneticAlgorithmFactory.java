...
public class JsspGeneticAlgorithmFactory
    implements IAlgorithmFactory<JsspPhenotype, Subject<Integer>> {
  ...
  public IAlgorithmAdapter<JsspPhenotype, Subject<Integer>> createAlgorithm(
      ProblemInstance instance, IPhenotypeEvaluator<JsspPhenotype> phenotypeEvaluator)
      throws Exception {
    return new GeneticAlgorithmAdapter<JsspPhenotype, Subject<Integer>>(new JsspGeneticOperator(),
        new JsspSubjectEvaluator((JsspPhenotypeEvaluator) phenotypeEvaluator), phenotypeEvaluator,
        false) {
      @Override

 ...
 * @author Jan Zmatlik
 */
public class JsspSimulatedAnnealingTest implements IAlgorithmListener<SimulatedAnnealingEvent>
{
    ...
    public static void main(String[] args)
    {
        try
        {
            ...
            new JsspSimulatedAnnealingTest().run(path);
        }
        catch (Exception ex)
        {
...
//
//        JsspObjectiveFunction objFunction = new JsspObjectiveFunction(_cities);

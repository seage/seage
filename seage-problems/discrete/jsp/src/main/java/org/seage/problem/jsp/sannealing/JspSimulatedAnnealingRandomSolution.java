...
public class JspSimulatedAnnealingRandomSolution extends JspSimulatedAnnealingSolution {
  public JspSimulatedAnnealingRandomSolution(JspPhenotypeEvaluator jspPhenoEval, JspJobsDefinition jobs) throws Exception {
    super(JspScheduleProvider.createRandomSchedule(jspPhenoEval, jobs, new Random().nextLong()).getSolution());
  }
}

 ...
 */
public class TspObjectiveFunction2 implements ObjectiveFunction
{
...
//		TspSwapMove m = (TspSwapMove)move;
//		if(m == null)
//			return evaluate((TspSolution)soln, null);
//		return evaluate((TspSolution)soln, );
//	}
    
    public double[] evaluate(Solution solution, Move m) throws Exception
    {
        try
        {        	
            ...
            {
            	TspSwapMove m2 = (TspSwapMove)m;
            	int[] move = new int[]{m2.customer, m2.movement};
                //int mv = (TspSwapMove) move;
                int pos1 = move[0];
                int pos2 = (pos1 + move[1]) % len;

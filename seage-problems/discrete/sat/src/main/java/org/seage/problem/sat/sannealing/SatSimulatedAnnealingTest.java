...
//
//        SimulatedAnnealing sa = new SimulatedAnnealing( new SatObjectiveFunction() , new SatMoveManager() );
//
...
//        for(int i=0;i<((SatSolution)sa.getBestSolution())._assign.length;i++){
//            System.out.print(((SatSolution)sa.getBestSolution())._assign[i]+", ");
//        }
//        System.out.println("\nEVAL: "+((SatSolution)sa.getBestSolution()).getObjectiveValue());
    }

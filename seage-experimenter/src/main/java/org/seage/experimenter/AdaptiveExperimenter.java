...
{    
    ...
    /**
     * @param ProblemInfo problemInfo - Instance of ProblemInfo
     * @param DataNode statistics - statistics from RapidMiner process
     * @param String algID - id of algortigm
     * 
     * @return DataNode - method return a DataNode with structure
     * 
     * ParamIntervals
     *   - Parameter: avg, dev, min, max, name attributes
     * 
     **/

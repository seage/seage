...
public class RapidMinerTest
{
    ...
    private static void testRepositoryProcessLocation()
    {
        ...
        try
        {
            ...
            if (entry instanceof ProcessEntry)
            {
                ...
                IOObjectCollection<SimpleExampleSet> result = (IOObjectCollection<SimpleExampleSet>) ioResult
                        .getElementAt(0);
    ...
    public void testCustomExampleSetOnInput0()
    {
        ...
        try
        {
            ...
            System.setProperty("rapidminer.home", rapidMinerHome);
            RapidMiner.setExecutionMode(RapidMiner.ExecutionMode.COMMAND_LINE);
            RepositoryManager.getInstance(null).addRepository(new LocalRepository(RAPIDMINER_LOCAL_REPOSITORY_NAME,
                    new File(RAPIDMINER_LOCAL_REPOSITORY_DIR_PATH)));
            RapidMiner.init();

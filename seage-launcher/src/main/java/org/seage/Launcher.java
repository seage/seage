...
public class Launcher
{
    ...
    private void run(String[] args) throws Exception
    {
        ...
        if (args[0].equals("-experiment-single-random"))
        {
            if (args.length == 1 + 5)
            {
                ...
                new SingleAlgorithmRandomExperimenter(numConfigs, timeoutS).runExperiment(args[3], args[4].split(","),
                        args[5].split(","));
        ...
        if (args[0].equals("-experiment-single-feedback"))
        {
            if (args.length == 1 + 5)
            {
                ...
                new SingleAlgorithmFeedbackExperimenter(numConfigs, timeoutS).runExperiment(args[3], args[4].split(","),
                        args[5].split(","));
    ...
    private void usage()
    {
        ...
        _logger.info(
                "\t-experiment-single-random    numOfConfigs algorithmTimeoutS problemID *|instanceID[,instanceID,...] *|algorithmID[,algorithmID,...]");
        _logger.info(
                "\t-experiment-single-feedback  numOfConfigs algorithmTimeoutS problemID *|instanceID[,instanceID,...] *|algorithmID[,algorithmID,...]");
        _logger.info(
                "\t-experiment-single-evolution numSubjects numIterations algorithmTimeoutS problemID *|instanceID[,instanceID,...] *|algorithmID[,algorithmID,...]");

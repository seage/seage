...
public abstract class AlgorithmParamsTableCreator extends DataTableCreator implements IDocumentProcessor {
  ...
  public static class GeneticAlgorithm extends AlgorithmParamsTableCreator {
    public GeneticAlgorithm(String dbPath) throws Exception {
      ...
      String queryCreate = "CREATE TABLE IF NOT EXISTS AlgorithmParams_GeneticAlgorithm" + "(" + "configID VARCHAR,"
          + "crossLengthPct DOUBLE PRECISION," + "eliteSubjectPct DOUBLE PRECISION,"
          + "iterationCount DOUBLE PRECISION," + "mutateLengthPct DOUBLE PRECISION,"
          + "mutateSubjectPct DOUBLE PRECISION," + "numSolutions DOUBLE PRECISION," + "randomSubjectPct REAL" + ")";
  ...
  public static class TabuSearch extends AlgorithmParamsTableCreator {
    public TabuSearch(String dbPath) throws Exception {
      ...
      String queryCreate = "CREATE TABLE IF NOT EXISTS AlgorithmParams_TabuSearch" + "(" + "configID VARCHAR,"
          + "iterationCount DOUBLE PRECISION," + "tabuListLength DOUBLE PRECISION," + "numSolutions REAL" + ")";
  ...
  public static class AntColony extends AlgorithmParamsTableCreator {
    public AntColony(String dbPath) throws Exception {
      ...
      String queryCreate = "CREATE TABLE IF NOT EXISTS AlgorithmParams_AntColony" + "(" + "configID VARCHAR,"
          + "alpha DOUBLE PRECISION," + "beta DOUBLE PRECISION," + "defaultPheromone DOUBLE PRECISION,"
          + "iterationCount DOUBLE PRECISION," + "numSolutions DOUBLE PRECISION,"
          + "qantumOfPheromone DOUBLE PRECISION," + "localEvaporation REAL" + ")";
  ...
  public static class SimulatedAnnealing extends AlgorithmParamsTableCreator {
    public SimulatedAnnealing(String dbPath) throws Exception {
      ...
      String queryCreate = "CREATE TABLE IF NOT EXISTS AlgorithmParams_SimulatedAnnealing" + "(" + "configID VARCHAR," +
      // "annealCoeficient DOUBLE,"+
          "numIterations DOUBLE PRECISION," + "maxTemperature DOUBLE PRECISION," + "minTemperature DOUBLE PRECISION," +
      ...
      // algSAXPaths.put("annealCoeficient", new
      // XmlHelper.XPath("/ExperimentTaskReport/Config/Algorithm/Parameters/@annealCoeficient"));
      ...
      // algSAXPaths.put("maxOneStepAcceptedSolutions", new
      // XmlHelper.XPath("/ExperimentTaskReport/Config/Algorithm/Parameters/@maxOneStepAcceptedSolutions"));
    ...
    public synchronized void processDocument(Document doc, String containerFileName) throws Exception {
      ...
      try (Connection conn = createConnection("")) {
        ...
        stmt.clearParameters();
        stmt.setString(1, getVersionedValue(doc, "configID", version));
        // _stmt.setDouble(2, Double.parseDouble(getVersionedValue(doc,
        // "annealCoeficient", version)));
        ...
        // _stmt.setDouble(6, Double.parseDouble(getVersionedValue(doc,
        // "maxOneStepAcceptedSolutions", version)));

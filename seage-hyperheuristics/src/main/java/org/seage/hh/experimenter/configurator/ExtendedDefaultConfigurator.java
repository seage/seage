...
public class ExtendedDefaultConfigurator extends Configurator {
  ...
  protected Map<String, Map<String, Map<String, Double>>> bestDefaultParams = Map.of(
      "SAT", Map.of(
        "GeneticAlgorithm", Map.of(
          ...
          /**
           * "GeneticAlgorithm", Map.of(
              "crossLengthPct", 16.13570202928119,
              "eliteSubjectPct", 16.13570202928119,
              "iterationCount", 938649.1154092173,
              "mutateLengthPct", 3.864297970718807,
              "mutateSubjectPct", 16.13570202928119,
              "numSolutions", 160.74345008988382,
              "randomSubjectPct", 3.864297970718807
          ),
          */
           ...
           * "AntColony", Map.of(
                "alpha", 1.0,
                "beta", 1.9710137211285783,
                "defaultPheromone", 1.0E-5,
                "iterationCount", 1000000.0,
                "localEvaporation", 0.8951207317935241,
                "numSolutions", 213.18849067585637,
    ...
    /**
         * "TabuSearch", Map.of(
            "iterationCount", 8.623870985731076E10,
            "numSolutions", 1.0,
            "tabuListLength", 167.47528852684022,
        )
    */
    ),
      "TSP", Map.of(
       ...
       * )
          "crossLengthPct", 0.0,
          "eliteSubjectPct", 0.0,
          "iterationCount", 870133.6665582203,
          "mutateLengthPct", 22.98793213739171,
          "mutateSubjectPct", 22.98793213739171,
          "numSolutions", 10.0,
          "randomSubjectPct", 0.0,
        }
      },
      */
      "SimulatedAnnealing", Map.of(
      ...
      // "AntColony", Map.of(
      //     "alpha", 2.132807099114193,
      //     "beta", 1.867192900885807,
      //     "defaultPheromone", 1.0E-5,
      //     "iterationCount", 1000000.0,
      //     "localEvaporation", 0.8895836213805763,
      //     "numSolutions", 10.0,
      //     "quantumOfPheromone", 1.0,
      //  ),
      // "TabuSearch", Map.of(
      //     "iterationCount", 8.206866507152858E10,
      //     "numSolutions", 1.0,
      //     "tabuListLength", 209.1340359372209,
      //  ),
      // "TabuSearch", Map.of(
      //     "iterationCount", 9.2779799435912E10,
      //     "numSolutions", 1.0,
      //     "tabuListLength", 102.12980363596046,
      //  ),
  ...
  // protected Map<String, Map<String, Map<String, Double>>> bestDefaultParams = new HashMap<>() {{
  //     put("SAT", new HashMap<>() {{
  ...
  // protected Map<String, Map<String, Map<String, Double>>> bestRandomParams = new HashMap<>() {
  //   {
  //     put("SAT", new HashMap<>() {{
  //         put("GeneticAlgorithm", new HashMap<>() {{

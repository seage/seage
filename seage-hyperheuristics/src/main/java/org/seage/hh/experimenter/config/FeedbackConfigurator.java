...
import org.seage.hh.knowledgebase.rapidminer.RapidMinerManager;
...
public class FeedbackConfigurator extends Configurator
{
            ...
            int numConfigs) throws Exception
    {
        ...
        if (realNumConfigs < numConfigs)
        {
            ...
            ProblemConfig[] pc = new RandomConfigurator().prepareConfigs(problemInfo, instanceID, algorithmID,
                    rndConfigs);

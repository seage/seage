 ...
 * @author jenik E -> E + T
 */
public class EMinusGrammarRule extends GrammarRule {

  /**
   * 
   */
  private static final long serialVersionUID = 3126261196088209106L;

  public EMinusGrammarRule(int uniqueId) {
